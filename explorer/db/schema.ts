/**
 * Read-only demonstration-shelf schema used by the Cloudflare D1 runtime.
 * The authoritative builder remains tools/build_demo_latin_corpus.py; this is
 * the deliberately smaller serving shape needed by diagnostic previews.
 */
export const latinShelfSchemaStatements = [
